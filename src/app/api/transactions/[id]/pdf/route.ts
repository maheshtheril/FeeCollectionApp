...
export async function GET(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const data = {
      ...
      orgPhone: transaction.invoice.enrollment.course.organization.phone,
      orgEmail: transaction.invoice.enrollment.course.organization.email,
      orgAddress: transaction.invoice.enrollment.course.organization.address,

...
async function main() {
  ...
  await Promise.all([
    ...
    page.waitForNavigation({ waitUntil: 'networkidle2' }).catch(e => console.log("Navigation timeout"))
  ]);
  ...
  if (currentUrl.includes('/signin')) {
    ...
    await page.screenshot({ path: 'login-failed2.png' });
  } else {
    console.log("Login succeeded! Taking screenshot...");
    await page.screenshot({ path: 'login-success2.png' });
  }
